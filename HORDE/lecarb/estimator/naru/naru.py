...
def train_naru(seed, dataset, version, workload, params, sizelimit):
    ...
    # for i in range(20):
    #     print(str(i)+"th:")
    #     print(table.data[i:i+1])
    #     print(train_data.tuples[i:i+1])
    ...
    # print("-----------------------------")
    # print(train_data.tuples_np)
    # print(torch.tensor(train_data.tuples_np).size())
    # print(train_data.tuples)
    # print(torch.tensor(train_data.tuples).size())
    # print("------------------------------")
    # return
    ...
    print(dataset, version, workload,'{:.1f} mins'.format(dur_min))
    # print(str(dataset)+str(version)+str(workload)+'{:.1f} mins'.format(dur_min))
    with open("./naru_time.txt","a+") as f:
        f.write(str(dataset)+" "+str(version)+" "+str(workload)+' {:.1f} mins'.format(dur_min)+"\n")
    ...
    label_out=[l.cardinality for l in labels]
    ...
    #     elif label_out[i]==0:
    #         p_value=preds[i]
    #     elif preds[i]>label_out[i]:
    #         p_value=preds[i]/label_out[i]
    #     else:
    #         p_value=label_out[i]/preds[i]

    #     # if p_value>4:
    #     print(i,preds[i],label_out[i],p_value)
